...
#   def test_should_parse_INFO_XML_OUTPUT
#     expected_result = { :revision => 328, :last_changed_revision => 328, :last_changed_author => 'stellsmi' }
...
#   def parse_log log_entry
#     return SubversionLogParser.new.parse_log( log_entry.split( "\n" ) )
#   end


#   def parse_update log_entry
#     return SubversionLogParser.new.parse_update( log_entry.split( "\n" ) )
#   end


#   def parse_info svn_output
#     return SubversionLogParser.new.parse_info( svn_output )
#   end
